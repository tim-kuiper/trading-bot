...
for z in range(1000000000):
    ...
    if random_element == 1:
        ...
        pyautogui.click(current_pos.x, current_pos.y, clicks=1, duration=0.1) # click
        ...
        move_rel(0,-100,0.1) # go up
        current_pos = pyautogui.position() # get current pos
        pyautogui.click(current_pos.x, current_pos.y, clicks=1, duration=0.1) # click
    # every 1000 iterations press f1
    if z % 1000 == 0:
        pyautogui.hotkey("F1")
    # every 250 iterations perform a long walk to decrease chances of getting stuck near edge of map
    if z % 250 == 0:
        if random_element == 1:
            move_rel(500,0,0.1) # go right
            current_pos = pyautogui.position() # get current pos
            pyautogui.click(current_pos.x, current_pos.y, clicks=1, duration=0.1) # click
        elif random_element == 2:
            move_rel(0,500,0.1) # go down
            current_pos = pyautogui.position() # get current pos
            pyautogui.click(current_pos.x, current_pos.y, clicks=1, duration=0.1) # click
        elif random_element == 3:
            move_rel(-500,0,0.1) # go left
            current_pos = pyautogui.position() # get current pos
            pyautogui.click(current_pos.x, current_pos.y, clicks=1, duration=0.1) # click
        elif random_element == 4:
            move_rel(0,-500,0.1) # go up
            current_pos = pyautogui.position() # get current pos
            pyautogui.click(current_pos.x, current_pos.y, clicks=1, duration=0.1) # click
