...
# main loop
while True:
  # open timeframe list file 1h/4h/24h
  # read timeframe list file 1h/4h/24h and put it var (list_1h, list_4h, list_24h)
  # append element to each list
  # write list to each list file
  list_1h.append(1)
  list_4h.append(4)
  list_24h.append(24)
  #if len(list_1h) == 1:
